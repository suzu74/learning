...
* 以前やった動画講座がわかりやすかったため。
* さらにReactの勉強をしたいと思ったため。
* フロントエンドのスキルも身に付けたいと思ったため。

### 感想

* 今回の講座もわかりやすく全体的に学べてよかった。
* しかし、現在使う予定のないものを多くあったので、そこは飛ばし飛ばしやった
* Chakra UI など新しいことも知れた

### 理解が浅い点・課題など

* 現在使う予定のないものは飛ばし飛ばしでやったため、必要になった場合は再度学習が必要
* フロントエンドの変化は早いためキャッチアップもしっかり行えるぐらいの基礎力を身に付けたい
* Reduxなども別途学習しないといけないと感じる

## webpack 最速入門 〜実務でも利用できるフロントエンド開発…webpack 最速入門 〜実務でも利用できるフロントエンド開発環境を構築する方法を最短で学ぶ〜

### なぜ学習しようと思ったか？

* 仕事でwebpackについて少し触れる機会があったため基本的な知識などを知りたくなったため
* 講座が3時間もないため効率的に学べると思ったため

### 感想

* ほぼ知識のない状態からなんとなくわかるぐらいになれた。
* 多くの時間をかけずにできたので良かった
* もっと学びたいと思えたのは良かった

### 理解が浅い点・課題など

* 全体的にあくまでもふんわりとした理解レベルな点
* 細かいオプションの指定や書き方などの理解が浅い
* 公式ドキュメントもチャレンジして理解をもう少し深める
